...
Redux::setSection( $opt_name, array(
	...
	'fields'           => array(
		...
		array(
			...
			'type'     => 'text',
			'title'    => esc_html__( 'Post Share Label', 'doyle' ),
			'subtitle' => esc_html__( 'Please, Enter label of the share. Leave empty to use "Share:" label.', 'doyle' ),
			'default'  => 'Share:',
		...
		array(
			...
			'type'     => 'switch',
			'title'    => esc_html__( 'Facebook', 'doyle' ),
			'subtitle' => esc_html__( 'Turn on to show the facebook share.', 'doyle' ),
			'default'  => true,
			'required' 		=> array('single_post_share' , '=', '1'),
		),
		array(
			...
			'type'     => 'switch',
			'title'    => esc_html__( 'Twitter', 'doyle' ),
			'subtitle' => esc_html__( 'Turn on to show the twitter share.', 'doyle' ),
			'default'  => true,
			'required' 		=> array('single_post_share' , '=', '1'),
		),
		array(
			...
			'type'     => 'switch',
			'title'    => esc_html__( 'Google Plus', 'doyle' ),
			'subtitle' => esc_html__( 'Turn on to show the google plus share.', 'doyle' ),
			'default'  => true,
			'required' 		=> array('single_post_share' , '=', '1'),
		),
		array(
			...
			'type'     => 'switch',
			'title'    => esc_html__( 'Linkedin', 'doyle' ),
			'subtitle' => esc_html__( 'Turn on to show the linkedin share.', 'doyle' ),
			'default'  => true,
			'required' 		=> array('single_post_share' , '=', '1'),
		),
		array(
			...
			'type'     => 'switch',
			'title'    => esc_html__( 'Pinterest', 'doyle' ),
			'subtitle' => esc_html__( 'Turn on to show the pinterest share.', 'doyle' ),
			'default'  => true,
			'required' 		=> array('single_post_share' , '=', '1'),
		),
		array(
