...
<?php 
	...
	if(isset($doyle_options['fixed_main_menu_v6']) && $doyle_options['fixed_main_menu_v6']) {
	...
	if($disable_stick_menu != 'on') {
		if(isset($doyle_options['stick_main_menu_v6']) && $doyle_options['stick_main_menu_v6']) {
...
<header>
	<div id="doyle_header" class="<?php echo esc_attr($class_header); ?>"><!-- bt-header-stick/bt-header-fixed -->
		...
		<div class="bt-header-top">
			<div class="container">
				<div class="row">
					<?php if (is_active_sidebar("doyle-header-top-v6-left")) { ?>
						<div class="col-md-10 bt-info-pp">
							<?php 
								dynamic_sidebar("doyle-header-top-v6-left");
							?>
						</div>
					<?php } ?>
					<?php if (is_active_sidebar("doyle-header-top-v6-right")) { ?>
						<div class="col-md-2 bt-lore">
							<?php 
								dynamic_sidebar("doyle-header-top-v6-right");
							?>
						</div>
					<?php } ?>
				</div>
