<?php
class doyle_Mini_Account_Widget extends WP_Widget {
    function __construct() {
        parent::__construct(
                'mini_account_widget', // Base ID
                __('Mini Account', 'doyle'), // Name
                array('description' => __('Mini Account Widget', 'doyle'),) // Args
        );
    }
    ...
    function form($instance) {
		...
		?>
		<p>
			<label for="<?php echo esc_url($this->get_field_id('login_text')); ?>"><?php _e('Login Text:', 'doyle');
		 ?></label>
		...
		<p>
			<label for="<?php echo esc_url($this->get_field_id('logout_text')); ?>"><?php _e('Logout Text:', 'doyle');
		 ?></label>
...
/**
 * Class doyle_Mini_Acount_Widget
 */
function doyle_register_mini_account_widget() {
    register_widget('doyle_Mini_Account_Widget');
}
add_action('widgets_init', 'doyle_register_mini_account_widget');
?>
