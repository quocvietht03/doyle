<?php
class doyle_New_Tabs_Widget extends WP_Widget {
    function __construct() {
        parent::__construct(
                'doyle_news_tabs_widget', // Base ID
                __('News Tabs', 'doyle'), // Name
                array('description' => __('News Tabs Widget', 'doyle'),) // Args
        );
    }
        ...
        <div class="tab-holder">
            <div class="tab-hold tabs-wrapper">
                <ul id="tabs" class="nav nav-tabs">
					<li class="active bt-tab" ><a href="#tab1" data-toggle="tab" ><?php echo __('Recent Post', 'doyle'); ?></a></li>
					<li class="bt-tab"><a href="#tab2" data-toggle="tab" ><?php echo __('Popular Post', 'doyle'); ?></a></li>
                </ul>
									...
									<li>
										...
										<div class="bt-details">
											<div class="bt-inner">
												...
												<ul class="bt-meta">
													<li class="bt-author"><?php echo __('By ', 'doyle').get_the_author(); ?></li>
...
/**
 * Class doyle_New_Tabs_Widget
 */
function register_new_tabs_widget() {
    register_widget('doyle_New_Tabs_Widget');
}
