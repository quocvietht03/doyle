...
vc_map(array(
	...
	'params' => array(
		...
		array(
			...
			'description' => __( 'Please, select logo for option - social_media.', 'doyle' ),
			'params' => array(
				array(
					'type' => 'textfield',
					'heading' => 'Name',
					'param_name' => 'name',
					'value' => '',
					'description' => __( 'Enter text used as name of social.', 'doyle' ),
					'admin_label' => true,
				),
				array(
					'type' => 'textfield',
				...
				array(
					...
					'param_name' => 'link',
					'description' => __( 'Add link of social in this element.', 'doyle' )
				),
			)
		),
		array(
