...
$manifest['id']                  = 'doyle';
$manifest['skin']                = 'main';
$manifest['name']                = esc_html__( 'Bearsthemes', 'doyle' );
$manifest['uri']                 = 'http://theme.bearsthemes.com/wordpress/doyle-demo/';
$manifest['description']         = esc_html__( 'WordPress Theme', 'doyle' );
