...
$fullwidth = isset($doyle_options['single_team_fullwidth'])&&$doyle_options['single_team_fullwidth'] ? 'fullwidth': 'container';
$sidebar_width = (int) isset($doyle_options['single_team_sidebar_width']) ?  $doyle_options['single_team_sidebar_width']: 3;
...
$single_team_titlebar = isset($doyle_options['single_team_titlebar']) ? $doyle_options['single_team_titlebar']: true;
if($single_team_titlebar) doyle_titlebar();
?>
			...
			<div class="row">
				...
				<div class="bt-content <?php echo esc_attr($content_class); ?>">
					...
					while ( have_posts() ) : the_post();
						get_template_part( 'framework/templates/team/single/entry');
					endwhile;
					?>
				</div>
				<!-- End Content -->
