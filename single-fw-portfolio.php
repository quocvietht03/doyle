...
$fullwidth = isset($doyle_options['single_portolio_fullwidth'])&&$doyle_options['single_portolio_fullwidth'] ? 'fullwidth': 'container';
$sidebar_width = (int) isset($doyle_options['single_portolio_sidebar_width']) ?  $doyle_options['single_portolio_sidebar_width']: 3;
$related_post = isset($doyle_options['single_portfolio_related_post']) ? $doyle_options['single_portfolio_related_post']: true;
$related_post_label = isset($doyle_options['single_portfolio_related_post_label'])&&$doyle_options['single_portfolio_related_post_label'] ? $doyle_options['single_portfolio_related_post_label']: esc_html__('Portfolio Related', 'doyle');
$related_post_count = (int) isset($doyle_options['single_portfolio_related_post_count'])&&$doyle_options['single_portfolio_related_post_count'] ? $doyle_options['single_portfolio_related_post_count']: 3;
$related_post_per_row = (int) isset($doyle_options['single_portfolio_related_post_per_row'])&&$doyle_options['single_portfolio_related_post_per_row'] ? $doyle_options['single_portfolio_related_post_per_row']: 3;
